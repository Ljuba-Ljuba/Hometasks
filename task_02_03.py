...
'''
def average(*lst):#неопределенное количество позиционированных перемнных

    how_many=len(lst)#определяем количество элементов в списке
    rezult=round(sum(lst)/how_many, 3)#вычисляем среднее арифметическое
    return rezult
